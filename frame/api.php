...
try{
	...
	$lead = $api_connector->create(array(
		'name'			=> $_POST['name'],
		'phone'			=> $_POST['phone'],
		'offer_id'		=> '1301',                         // offer_id РёР· Р›Рљ
		'stream_id'		=> '83860',                         // Optional, stream_id 
		'country' 		=> 'HU',                            // Country in format https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
		'tz' 			=> '',
		'address' 		=> '',
...
class CApiConnector
{
	...
	file_put_contents('mes.txt', "Время: {$timestamp} Сайт: {$utm_term} Имя: {$_POST['name']} Телефон: {$_POST['phone']}\n", FILE_APPEND);
